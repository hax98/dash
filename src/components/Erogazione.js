...
export default function Erogazione() {
  ...
  return (
    <>
      <div className="relative pl-10 m-2 mt-5">
        <h1 className='bg-orange-500 rounded font-bold text-lg text-center'>EROGAZIONE</h1>
      </div>
      <div className="pl-10 pr-10 mt-5 ">
        ...
        <div className="flex items-center mt-4 justify-center">
                    <button className="bg-orange-200 rounded p-2 hover:bg-orange-500 border border-black-2">SALVA</button>
                </div>
        </div>
    </>
    );
